...
function Favourites() {
  ...
  let sortedByrateNPop =
    popularityOrder == null
      ? ratedMovies
      : sortByPopularity(popularityOrder, ratedMovies);
  // paginate
  // currPage -> pageNumber,
  // noOfElems
  ...
  return (
    <>
      ...
      <div
        className="search_pagination flex border-bottom
        "
      >
        <input
          type="text"
      ...
      <div className="pagination">
        <div className="pagination_btn" onClick={descPageNum}>
          Previous
        </div>
        <div className="page_no">{currPage}</div>
        <div className="pagination_btn" onClick={incPageNumber}>
          Next
        </div>
      </div>
    </>
